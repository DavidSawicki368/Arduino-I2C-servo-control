...
void loop() {
  ...
  addVal = joyValX + joyValY;
  Serial.println(addVal);

  

  uint16_t servonum = 0;
  joyVal = map (addVal, 0, 2046, 150, 600); // Servo value between 0-180
  uint16_t pulselen = joyVal; 
    pwm.setPWM(servonum, 0, pulselen);

   servonum = 1;
  joyVal = map (joyVal, 0, 2046, 150, 600); // Servo value between 0-180
  pulselen = joyVal; 
